...
namespace ClientConsumer.EvalServiceCRRM {
    ...
    [System.ServiceModel.ServiceContractAttribute(ConfigurationName="EvalServiceCRRM.IEvalService")]
    public interface IEvalService {
        ...
        void SubmitEval(ClientConsumer.EvalServiceCRRM.Eval eval);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IEvalService/SubmitEval", ReplyAction="http://tempuri.org/IEvalService/SubmitEvalResponse")]
        System.Threading.Tasks.Task SubmitEvalAsync(ClientConsumer.EvalServiceCRRM.Eval eval);
        ...
        ClientConsumer.EvalServiceCRRM.Eval[] GetEvals();
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IEvalService/GetEvals", ReplyAction="http://tempuri.org/IEvalService/GetEvalsResponse")]
        System.Threading.Tasks.Task<ClientConsumer.EvalServiceCRRM.Eval[]> GetEvalsAsync();
    ...
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface IEvalServiceChannel : ClientConsumer.EvalServiceCRRM.IEvalService, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class EvalServiceClient : System.ServiceModel.ClientBase<ClientConsumer.EvalServiceCRRM.IEvalService>, ClientConsumer.EvalServiceCRRM.IEvalService {
        ...
        public void SubmitEval(ClientConsumer.EvalServiceCRRM.Eval eval) {
            base.Channel.SubmitEval(eval);
        }
        
        public System.Threading.Tasks.Task SubmitEvalAsync(ClientConsumer.EvalServiceCRRM.Eval eval) {
            return base.Channel.SubmitEvalAsync(eval);
        }
        
        public ClientConsumer.EvalServiceCRRM.Eval[] GetEvals() {
            return base.Channel.GetEvals();
        }
        
        public System.Threading.Tasks.Task<ClientConsumer.EvalServiceCRRM.Eval[]> GetEvalsAsync() {

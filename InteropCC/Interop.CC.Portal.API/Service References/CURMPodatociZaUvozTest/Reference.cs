...
namespace Interop.CC.Portal.API.CURMPodatociZaUvozTest {
    ...
    [System.ServiceModel.ServiceContractAttribute(Namespace="http://interop.org/", ConfigurationName="CURMPodatociZaUvozTest.IDataExeImp")]
    public interface IDataExeImp {
        ...
        [System.ServiceModel.FaultContractAttribute(typeof(Interop.CC.Portal.API.CURMPodatociZaUvozTest.InteropFault), Action="http://interop.org/IDataExeImp/GetDataExeImpInteropFaultFault", Name="InteropFault", Namespace="http://schemas.datacontract.org/2004/07/Contracts.DataAccessLibrary")]
        Interop.CC.Portal.API.CURMPodatociZaUvozTest.ExecutedImportOutput[] GetDataExeImp(Interop.CC.Portal.API.CURMPodatociZaUvozTest.ExecutedImportInput input);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://interop.org/IDataExeImp/GetDataExeImp", ReplyAction="http://interop.org/IDataExeImp/GetDataExeImpResponse")]
        System.Threading.Tasks.Task<Interop.CC.Portal.API.CURMPodatociZaUvozTest.ExecutedImportOutput[]> GetDataExeImpAsync(Interop.CC.Portal.API.CURMPodatociZaUvozTest.ExecutedImportInput input);
    }
    
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface IDataExeImpChannel : Interop.CC.Portal.API.CURMPodatociZaUvozTest.IDataExeImp, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class DataExeImpClient : System.ServiceModel.ClientBase<Interop.CC.Portal.API.CURMPodatociZaUvozTest.IDataExeImp>, Interop.CC.Portal.API.CURMPodatociZaUvozTest.IDataExeImp {
        ...
        public Interop.CC.Portal.API.CURMPodatociZaUvozTest.ExecutedImportOutput[] GetDataExeImp(Interop.CC.Portal.API.CURMPodatociZaUvozTest.ExecutedImportInput input) {
            return base.Channel.GetDataExeImp(input);
        }
        
        public System.Threading.Tasks.Task<Interop.CC.Portal.API.CURMPodatociZaUvozTest.ExecutedImportOutput[]> GetDataExeImpAsync(Interop.CC.Portal.API.CURMPodatociZaUvozTest.ExecutedImportInput input) {

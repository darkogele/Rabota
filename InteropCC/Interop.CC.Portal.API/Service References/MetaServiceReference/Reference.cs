...
namespace Interop.CC.Portal.API.MetaServiceReference {
    ...
    public partial class ProviderCCDTO : object, System.Runtime.Serialization.IExtensibleDataObject, System.ComponentModel.INotifyPropertyChanged {
        ...
        [System.Runtime.Serialization.OptionalFieldAttribute()]
        private string ProviderMimField;
        ...
        [System.Runtime.Serialization.DataMemberAttribute()]
        public string ProviderMim {
            get {
                return this.ProviderMimField;
            }
            set {
                if ((object.ReferenceEquals(this.ProviderMimField, value) != true)) {
                    this.ProviderMimField = value;
                    this.RaisePropertyChanged("ProviderMim");
                }
            }
        }
    ...
    public interface IMetaService {
        ...
        Interop.CC.Portal.API.MetaServiceReference.ProviderCCDTO[] GetProviders();
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IMetaService/GetProviders", ReplyAction="http://tempuri.org/IMetaService/GetProvidersResponse")]
        System.Threading.Tasks.Task<Interop.CC.Portal.API.MetaServiceReference.ProviderCCDTO[]> GetProvidersAsync();
        ...
        System.Web.Mvc.SelectListItem[] GetServices(string providerId);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IMetaService/GetServices", ReplyAction="http://tempuri.org/IMetaService/GetServicesResponse")]
        System.Threading.Tasks.Task<System.Web.Mvc.SelectListItem[]> GetServicesAsync(string providerId);
        ...
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IMetaService/GetServiceRolesAfterGetProvider", ReplyAction="http://tempuri.org/IMetaService/GetServiceRolesAfterGetProviderResponse")]
        string[] GetServiceRolesAfterGetProvider(string loggedUser, string[] providersCodes);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IMetaService/GetServiceRolesAfterGetProvider", ReplyAction="http://tempuri.org/IMetaService/GetServiceRolesAfterGetProviderResponse")]
        System.Threading.Tasks.Task<string[]> GetServiceRolesAfterGetProviderAsync(string loggedUser, string[] providersCodes);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IMetaService/CreateOrDeleteServicesRoles", ReplyAction="http://tempuri.org/IMetaService/CreateOrDeleteServicesRolesResponse")]
        string[] CreateOrDeleteServicesRoles(string[] serviceRolesFromGetProviders, string loggedUser);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IMetaService/CreateOrDeleteServicesRoles", ReplyAction="http://tempuri.org/IMetaService/CreateOrDeleteServicesRolesResponse")]
        System.Threading.Tasks.Task<string[]> CreateOrDeleteServicesRolesAsync(string[] serviceRolesFromGetProviders, string loggedUser);
    }
    
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface IMetaServiceChannel : Interop.CC.Portal.API.MetaServiceReference.IMetaService, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class MetaServiceClient : System.ServiceModel.ClientBase<Interop.CC.Portal.API.MetaServiceReference.IMetaService>, Interop.CC.Portal.API.MetaServiceReference.IMetaService {
        ...
        public Interop.CC.Portal.API.MetaServiceReference.ProviderCCDTO[] GetProviders() {
            return base.Channel.GetProviders();
        }
        
        public System.Threading.Tasks.Task<Interop.CC.Portal.API.MetaServiceReference.ProviderCCDTO[]> GetProvidersAsync() {
            return base.Channel.GetProvidersAsync();
        }
        
        public System.Web.Mvc.SelectListItem[] GetServices(string providerId) {
            return base.Channel.GetServices(providerId);
        }
        
        public System.Threading.Tasks.Task<System.Web.Mvc.SelectListItem[]> GetServicesAsync(string providerId) {
        ...
        public string[] GetServiceRolesAfterGetProvider(string loggedUser, string[] providersCodes) {
            return base.Channel.GetServiceRolesAfterGetProvider(loggedUser, providersCodes);
        }
        
        public System.Threading.Tasks.Task<string[]> GetServiceRolesAfterGetProviderAsync(string loggedUser, string[] providersCodes) {
            return base.Channel.GetServiceRolesAfterGetProviderAsync(loggedUser, providersCodes);
        }
        
        public string[] CreateOrDeleteServicesRoles(string[] serviceRolesFromGetProviders, string loggedUser) {
            return base.Channel.CreateOrDeleteServicesRoles(serviceRolesFromGetProviders, loggedUser);
        }
        
        public System.Threading.Tasks.Task<string[]> CreateOrDeleteServicesRolesAsync(string[] serviceRolesFromGetProviders, string loggedUser) {
            return base.Channel.CreateOrDeleteServicesRolesAsync(serviceRolesFromGetProviders, loggedUser);
        }
    }
}

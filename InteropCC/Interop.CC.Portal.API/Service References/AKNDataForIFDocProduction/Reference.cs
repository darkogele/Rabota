...
namespace Interop.CC.Portal.API.AKNDataForIFDocProduction {
    ...
    public interface IAKNDataForIFDocProduction {
        ...
        Interop.CC.Portal.API.AKNDataForIFDocProduction.AKNDocOutput GetIFDoc(string opstina, string katastarskaOpstina, string brImotenList, string brParcela, bool ShowEMB);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://interop.org/IAKNDataForIFDocProduction/GetIFDoc", ReplyAction="http://interop.org/IAKNDataForIFDocProduction/GetIFDocResponse")]
        System.Threading.Tasks.Task<Interop.CC.Portal.API.AKNDataForIFDocProduction.AKNDocOutput> GetIFDocAsync(string opstina, string katastarskaOpstina, string brImotenList, string brParcela, bool ShowEMB);
    }
    
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface IAKNDataForIFDocProductionChannel : Interop.CC.Portal.API.AKNDataForIFDocProduction.IAKNDataForIFDocProduction, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class AKNDataForIFDocProductionClient : System.ServiceModel.ClientBase<Interop.CC.Portal.API.AKNDataForIFDocProduction.IAKNDataForIFDocProduction>, Interop.CC.Portal.API.AKNDataForIFDocProduction.IAKNDataForIFDocProduction {
        ...
        public Interop.CC.Portal.API.AKNDataForIFDocProduction.AKNDocOutput GetIFDoc(string opstina, string katastarskaOpstina, string brImotenList, string brParcela, bool ShowEMB) {
            return base.Channel.GetIFDoc(opstina, katastarskaOpstina, brImotenList, brParcela, ShowEMB);
        }
        
        public System.Threading.Tasks.Task<Interop.CC.Portal.API.AKNDataForIFDocProduction.AKNDocOutput> GetIFDocAsync(string opstina, string katastarskaOpstina, string brImotenList, string brParcela, bool ShowEMB) {

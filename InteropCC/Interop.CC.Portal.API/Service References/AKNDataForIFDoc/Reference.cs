...
namespace Interop.CC.Portal.API.AKNDataForIFDoc {
    ...
    [System.ServiceModel.ServiceContractAttribute(Namespace="http://interop.org/", ConfigurationName="AKNDataForIFDoc.IAKNDataForIFDoc")]
    public interface IAKNDataForIFDoc {
        ...
        Interop.CC.Portal.API.AKNDataForIFDoc.AKNDocOutput GetDataForIFDoc(string opstina, string katastarskaOpstina, string brImotenList, string brParcela, bool ShowEMB);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://interop.org/IAKNDataForIFDoc/GetDataForIFDoc", ReplyAction="http://interop.org/IAKNDataForIFDoc/GetDataForIFDocResponse")]
        System.Threading.Tasks.Task<Interop.CC.Portal.API.AKNDataForIFDoc.AKNDocOutput> GetDataForIFDocAsync(string opstina, string katastarskaOpstina, string brImotenList, string brParcela, bool ShowEMB);
    }
    
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface IAKNDataForIFDocChannel : Interop.CC.Portal.API.AKNDataForIFDoc.IAKNDataForIFDoc, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class AKNDataForIFDocClient : System.ServiceModel.ClientBase<Interop.CC.Portal.API.AKNDataForIFDoc.IAKNDataForIFDoc>, Interop.CC.Portal.API.AKNDataForIFDoc.IAKNDataForIFDoc {
        ...
        public Interop.CC.Portal.API.AKNDataForIFDoc.AKNDocOutput GetDataForIFDoc(string opstina, string katastarskaOpstina, string brImotenList, string brParcela, bool ShowEMB) {
            return base.Channel.GetDataForIFDoc(opstina, katastarskaOpstina, brImotenList, brParcela, ShowEMB);
        }
        
        public System.Threading.Tasks.Task<Interop.CC.Portal.API.AKNDataForIFDoc.AKNDocOutput> GetDataForIFDocAsync(string opstina, string katastarskaOpstina, string brImotenList, string brParcela, bool ShowEMB) {

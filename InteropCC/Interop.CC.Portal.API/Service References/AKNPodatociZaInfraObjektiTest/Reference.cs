...
namespace Interop.CC.Portal.API.AKNPodatociZaInfraObjektiTest {
    ...
    [System.ServiceModel.ServiceContractAttribute(Namespace="http://interop.org/", ConfigurationName="AKNPodatociZaInfraObjektiTest.IAKNDataForIFDoc")]
    public interface IAKNDataForIFDoc {
        ...
        Interop.CC.Portal.API.AKNPodatociZaInfraObjektiTest.AKNDocOutput GetDataForIFDoc(string opstina, string katastarskaOpstina, string brImotenList, string brParcela, bool showEmb);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://interop.org/IAKNDataForIFDoc/GetDataForIFDoc", ReplyAction="http://interop.org/IAKNDataForIFDoc/GetDataForIFDocResponse")]
        System.Threading.Tasks.Task<Interop.CC.Portal.API.AKNPodatociZaInfraObjektiTest.AKNDocOutput> GetDataForIFDocAsync(string opstina, string katastarskaOpstina, string brImotenList, string brParcela, bool showEmb);
    }
    
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface IAKNDataForIFDocChannel : Interop.CC.Portal.API.AKNPodatociZaInfraObjektiTest.IAKNDataForIFDoc, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class AKNDataForIFDocClient : System.ServiceModel.ClientBase<Interop.CC.Portal.API.AKNPodatociZaInfraObjektiTest.IAKNDataForIFDoc>, Interop.CC.Portal.API.AKNPodatociZaInfraObjektiTest.IAKNDataForIFDoc {
        ...
        public Interop.CC.Portal.API.AKNPodatociZaInfraObjektiTest.AKNDocOutput GetDataForIFDoc(string opstina, string katastarskaOpstina, string brImotenList, string brParcela, bool showEmb) {
            return base.Channel.GetDataForIFDoc(opstina, katastarskaOpstina, brImotenList, brParcela, showEmb);
        }
        
        public System.Threading.Tasks.Task<Interop.CC.Portal.API.AKNPodatociZaInfraObjektiTest.AKNDocOutput> GetDataForIFDocAsync(string opstina, string katastarskaOpstina, string brImotenList, string brParcela, bool showEmb) {

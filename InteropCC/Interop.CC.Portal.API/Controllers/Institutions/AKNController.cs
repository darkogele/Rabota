        ...
        public IEnumerable<MunicipalityDTO> GetMunicipalities()
        {
            ...
            try
            {
                ...
                if (enviroment == "Production")
                {
                    ...
                    var aknClient = new AKNOpshtiniProduction.AKNMunicipalityClient();
                ...
                {
                    var aknClient = new AKNOpshtiniTest.AKNMunicipalityClient();
                    var cadastralMunicipalityList = aknClient.GetMunicipalities();
                    return cadastralMunicipalityList.Select(x => new MunicipalityDTO
                    {
                        Name = x.Name,
                        Value = x.Value
                    });
        ...
        public IEnumerable<MunicipalityDTO> GetCadastralMunicipalities(int municipalityValue)
        {
            ...
            try
            {
                ...
                if (enviroment == "Production")
                {
                    //var aknClient = new AKNMunicipalityService.AKNMunicipalityClient();
                    var aknClient = new AKNOpshtiniProduction.AKNMunicipalityClient();
                    var cadastralMunicipalityList = aknClient.GetCMunicipalities(municipalityValue.ToString());

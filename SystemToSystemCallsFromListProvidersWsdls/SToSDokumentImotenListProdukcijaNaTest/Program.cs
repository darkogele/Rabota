                    ...
                    case 1:
                        {
                            try
                            {
                                ...
                                Console.WriteLine("You can find the created document in 'C:\\LogsFromConsoleApps\\OutputResults\\DocumentImotenList.pdf'");
                            ...
                            catch (Exception ex)
                            {
                                ...
                                Console.WriteLine("Exception when call to PRODUCTION service AKNPListDocProduction: {0}", ex.Message);
                            }
                            break;
                        }

            ...
            while (true)
            {
                ...
                switch (result)
                {
                    ...
                    case 1:
                    {
                        try
                        {
                            Console.WriteLine("Call to PRODUCTION service PropertyList - GetPropertyList");
                        ...
                        catch (FaultException ex)
                        {
                            ...
                            Console.WriteLine("FaultException when Call to PRODUCTION service AKNPopertyListProduction. {0}", ex.Message);
                            Console.ReadLine();
                        }
                        catch (Exception ex)
                        {
                            ...
                            Console.WriteLine("Exception when Call to PRODUCTION service AKNPopertyListProduction: {0}", ex.Message);
                            Console.ReadLine();
                        }
                        break;
                    }

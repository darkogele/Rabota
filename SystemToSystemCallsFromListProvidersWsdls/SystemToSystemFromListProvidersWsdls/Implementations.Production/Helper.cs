...
namespace Implementations.Production
{
    public class Helper
    {
        ...
        public static XmlDocument CRM_XML_Request(string edb)
        {
        ...
        public static XmlDocument CRM_XML_AKN_Prod_Request(string embg)
        {
            var xdoc = new XDocument(
              new XElement("CrmRequest",
        ...
        public static XmlDocument CRM_TS_CURM_Prod_Request(string embg)
        {
            var xdoc = new XDocument(
                   new XElement("CrmRequest",
        ...
        public static XmlDocument CRM_TS_UJP_Prod_Request(string embg)
        {
            var xdoc = new XDocument(
              new XElement("CrmRequest",
        ...
        public static XmlDocument ListOfSubjects_Prod_Request(string embg, int updateType, int listType)
        {
            var xdoc = new XDocument(
                   new XElement("CrmRequest",
        ...
        public static XmlDocument ListOfChangesCU_Prod_Request(string date, int listype)
        {
            var xdoc = new XDocument(
                   new XElement("CrmRequest",

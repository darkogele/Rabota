...
namespace ImplementationsTest.Helpers.YearsOfWorkExperience
{
    public static class ObjectGeneratorHelper
    {
        ...
        {
            var output = new List<YWEInsuranceData>();
            while (reader.Read())
            {
        ...
        {
            var output = new List<YWEOldAndForegnExperience>();
            while (reader.Read())
            {
        ...
        {
            var output = new List<YWEInvalidM4>();
            while (reader.Read())
            {

...
using Contracts.Interfaces.IListOfChangesCU;
using Helpers;

namespace Implementations.Test.Implementations.ListOfChangesCU
{
    public class ListOfChangesCU_Test : IListOfChangesCU
    {
        public string GetListOfChangesCU(string param)
        {
            try
            {
                ...
                if (responseInfoMsg != null && !string.IsNullOrEmpty(responseInfoMsg.InnerText) && responseInfoMsg.InnerText.Contains("NOK"))
                {

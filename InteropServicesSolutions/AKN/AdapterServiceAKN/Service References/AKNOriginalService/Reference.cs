...
namespace AdapterServiceAKN.AKNOriginalService {
    using System.Data;
    
    
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    [System.ServiceModel.ServiceContractAttribute(Namespace="http://www.katastar.gov.mk/", ConfigurationName="AKNOriginalService.Service_MACEDONIAN_CADASTRESoap")]
    public interface Service_MACEDONIAN_CADASTRESoap {
        ...
        [System.ServiceModel.XmlSerializerFormatAttribute(SupportFaults=true)]
        AdapterServiceAKN.AKNOriginalService.dzgr VRATIPODATOCI_STRUKTURA_DZGR(string us, string ps, string ops, string kops, string ilist);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://www.katastar.gov.mk/VRATIPODATOCI_STRUKTURA_DZGR", ReplyAction="*")]
        System.Threading.Tasks.Task<AdapterServiceAKN.AKNOriginalService.dzgr> VRATIPODATOCI_STRUKTURA_DZGRAsync(string us, string ps, string ops, string kops, string ilist);
        ...
        [System.ServiceModel.XmlSerializerFormatAttribute(SupportFaults=true)]
        AdapterServiceAKN.AKNOriginalService.ATRparceli VRATIPODATOCI_STRUKTURA_PARCELA(string us, string ps, string ops, string kops, string broj);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://www.katastar.gov.mk/VRATIPODATOCI_STRUKTURA_PARCELA", ReplyAction="*")]
        System.Threading.Tasks.Task<AdapterServiceAKN.AKNOriginalService.ATRparceli> VRATIPODATOCI_STRUKTURA_PARCELAAsync(string us, string ps, string ops, string kops, string broj);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://www.katastar.gov.mk/VRATIulici", ReplyAction="*")]
        [System.ServiceModel.XmlSerializerFormatAttribute(SupportFaults=true)]
        AdapterServiceAKN.AKNOriginalService.ulici VRATIulici(string us);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://www.katastar.gov.mk/VRATIulici", ReplyAction="*")]
        System.Threading.Tasks.Task<AdapterServiceAKN.AKNOriginalService.ulici> VRATIuliciAsync(string us);
    }
    ...
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface Service_MACEDONIAN_CADASTRESoapChannel : AdapterServiceAKN.AKNOriginalService.Service_MACEDONIAN_CADASTRESoap, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class Service_MACEDONIAN_CADASTRESoapClient : System.ServiceModel.ClientBase<AdapterServiceAKN.AKNOriginalService.Service_MACEDONIAN_CADASTRESoap>, AdapterServiceAKN.AKNOriginalService.Service_MACEDONIAN_CADASTRESoap {
        ...
        public AdapterServiceAKN.AKNOriginalService.dzgr VRATIPODATOCI_STRUKTURA_DZGR(string us, string ps, string ops, string kops, string ilist) {
            return base.Channel.VRATIPODATOCI_STRUKTURA_DZGR(us, ps, ops, kops, ilist);
        }
        
        public System.Threading.Tasks.Task<AdapterServiceAKN.AKNOriginalService.dzgr> VRATIPODATOCI_STRUKTURA_DZGRAsync(string us, string ps, string ops, string kops, string ilist) {
        ...
        public AdapterServiceAKN.AKNOriginalService.ATRparceli VRATIPODATOCI_STRUKTURA_PARCELA(string us, string ps, string ops, string kops, string broj) {
            return base.Channel.VRATIPODATOCI_STRUKTURA_PARCELA(us, ps, ops, kops, broj);
        }
        
        public System.Threading.Tasks.Task<AdapterServiceAKN.AKNOriginalService.ATRparceli> VRATIPODATOCI_STRUKTURA_PARCELAAsync(string us, string ps, string ops, string kops, string broj) {
            return base.Channel.VRATIPODATOCI_STRUKTURA_PARCELAAsync(us, ps, ops, kops, broj);
        }
        
        public AdapterServiceAKN.AKNOriginalService.ulici VRATIulici(string us) {
            return base.Channel.VRATIulici(us);
        }
        
        public System.Threading.Tasks.Task<AdapterServiceAKN.AKNOriginalService.ulici> VRATIuliciAsync(string us) {

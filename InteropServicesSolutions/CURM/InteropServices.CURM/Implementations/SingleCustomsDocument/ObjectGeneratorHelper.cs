...
namespace InteropServices.CURM.Implementations
{
    public static class ObjectGeneratorHelper
    {
        ...
        {
            SCDGeneralData output = new SCDGeneralData();
            while (reader.Read())
            {
        ...
        {
            List<SCDItemData> output = new List<SCDItemData>();
            while (reader.Read())
            {
        ...
        {
            SCDExporterData output = new SCDExporterData();
            while (reader.Read())
            {
        ...
        {
            SCDImporterData output = new SCDImporterData();
            while (reader.Read())
            {

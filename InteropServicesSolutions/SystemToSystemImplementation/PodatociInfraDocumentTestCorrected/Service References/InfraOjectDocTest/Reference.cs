...
namespace PodatociInfraDocumentTestCorrected.InfraOjectDocTest {
    ...
    [System.ServiceModel.ServiceContractAttribute(Namespace="http://interop.org/", ConfigurationName="InfraOjectDocTest.IAKNDataForIFDoc")]
    public interface IAKNDataForIFDoc {
        ...
        PodatociInfraDocumentTestCorrected.InfraOjectDocTest.AKNDocOutput GetDataForIFDoc(string opstina, string katastarskaOpstina, string brImotenList, string brParcela, bool showEmb);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://interop.org/IAKNDataForIFDoc/GetDataForIFDoc", ReplyAction="http://interop.org/IAKNDataForIFDoc/GetDataForIFDocResponse")]
        System.Threading.Tasks.Task<PodatociInfraDocumentTestCorrected.InfraOjectDocTest.AKNDocOutput> GetDataForIFDocAsync(string opstina, string katastarskaOpstina, string brImotenList, string brParcela, bool showEmb);
    }
    
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface IAKNDataForIFDocChannel : PodatociInfraDocumentTestCorrected.InfraOjectDocTest.IAKNDataForIFDoc, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class AKNDataForIFDocClient : System.ServiceModel.ClientBase<PodatociInfraDocumentTestCorrected.InfraOjectDocTest.IAKNDataForIFDoc>, PodatociInfraDocumentTestCorrected.InfraOjectDocTest.IAKNDataForIFDoc {
        ...
        public PodatociInfraDocumentTestCorrected.InfraOjectDocTest.AKNDocOutput GetDataForIFDoc(string opstina, string katastarskaOpstina, string brImotenList, string brParcela, bool showEmb) {
            return base.Channel.GetDataForIFDoc(opstina, katastarskaOpstina, brImotenList, brParcela, showEmb);
        }
        
        public System.Threading.Tasks.Task<PodatociInfraDocumentTestCorrected.InfraOjectDocTest.AKNDocOutput> GetDataForIFDocAsync(string opstina, string katastarskaOpstina, string brImotenList, string brParcela, bool showEmb) {

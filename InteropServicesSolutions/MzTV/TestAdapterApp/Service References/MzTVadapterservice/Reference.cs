...
namespace TestAdapterApp.MzTVadapterservice {
    ...
    public partial class InteropOutputViewModel : object, System.Runtime.Serialization.IExtensibleDataObject, System.ComponentModel.INotifyPropertyChanged {
        ...
        [System.Runtime.Serialization.OptionalFieldAttribute()]
        private TestAdapterApp.MzTVadapterservice.ArrayOfString InvestorsField;
        ...
        [System.Runtime.Serialization.OptionalFieldAttribute()]
        private TestAdapterApp.MzTVadapterservice.InteropRequestMunicipalityViewModel[] MunicipalitiesField;
        
        private System.Nullable<System.DateTime> EffectDateField;
        
        [System.Runtime.Serialization.OptionalFieldAttribute()]
        private TestAdapterApp.MzTVadapterservice.InteropDocumentsViewModel[] DocumentsField;
        ...
        public TestAdapterApp.MzTVadapterservice.ArrayOfString Investors {
            get {
        ...
        public TestAdapterApp.MzTVadapterservice.InteropRequestMunicipalityViewModel[] Municipalities {
            get {
        ...
        public TestAdapterApp.MzTVadapterservice.InteropDocumentsViewModel[] Documents {
            get {
    ...
    public partial class InteropRequestMunicipalityViewModel : object, System.Runtime.Serialization.IExtensibleDataObject, System.ComponentModel.INotifyPropertyChanged {
        ...
        [System.Runtime.Serialization.OptionalFieldAttribute()]
        private TestAdapterApp.MzTVadapterservice.InteropCadastreMunicipalityViewModel[] CadastreMunicipalitiesField;
        ...
        [System.Runtime.Serialization.DataMemberAttribute(EmitDefaultValue=false, Order=1)]
        public TestAdapterApp.MzTVadapterservice.InteropCadastreMunicipalityViewModel[] CadastreMunicipalities {
            get {
    ...
    [System.ServiceModel.ServiceContractAttribute(ConfigurationName="MzTVadapterservice.IMzTVAdapter")]
    public interface IMzTVAdapter {
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IMzTVAdapter/GetConstructionPermitData", ReplyAction="http://tempuri.org/IMzTVAdapter/GetConstructionPermitDataResponse")]
        TestAdapterApp.MzTVadapterservice.InteropOutputViewModel GetConstructionPermitData(string archiveNumber, string constructionTypeId, string municipalityId, string sendDate, string getDocuments);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IMzTVAdapter/GetConstructionPermitData", ReplyAction="http://tempuri.org/IMzTVAdapter/GetConstructionPermitDataResponse")]
        System.Threading.Tasks.Task<TestAdapterApp.MzTVadapterservice.InteropOutputViewModel> GetConstructionPermitDataAsync(string archiveNumber, string constructionTypeId, string municipalityId, string sendDate, string getDocuments);
    }
    
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface IMzTVAdapterChannel : TestAdapterApp.MzTVadapterservice.IMzTVAdapter, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class MzTVAdapterClient : System.ServiceModel.ClientBase<TestAdapterApp.MzTVadapterservice.IMzTVAdapter>, TestAdapterApp.MzTVadapterservice.IMzTVAdapter {
        ...
        public TestAdapterApp.MzTVadapterservice.InteropOutputViewModel GetConstructionPermitData(string archiveNumber, string constructionTypeId, string municipalityId, string sendDate, string getDocuments) {
            return base.Channel.GetConstructionPermitData(archiveNumber, constructionTypeId, municipalityId, sendDate, getDocuments);
        }
        
        public System.Threading.Tasks.Task<TestAdapterApp.MzTVadapterservice.InteropOutputViewModel> GetConstructionPermitDataAsync(string archiveNumber, string constructionTypeId, string municipalityId, string sendDate, string getDocuments) {
            return base.Channel.GetConstructionPermitDataAsync(archiveNumber, constructionTypeId, municipalityId, sendDate, getDocuments);
        }
    }
}

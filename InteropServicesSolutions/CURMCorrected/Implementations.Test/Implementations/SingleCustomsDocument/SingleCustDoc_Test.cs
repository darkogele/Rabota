...
using Implementations.Test.Helpers.SingleCustomsDocument;

namespace Implementations.Test.Implementations.SingleCustomsDocument
{
    ...
    public class SingleCustDoc_Test : ISingleCustDoc
    {
        ...
        public SingleCustomsDocumentOutput GetSingleCustDoc(int year, long edbOfShippingCompany, int numberOfCustomsOffice, int regNumber)
        {
            ...
            try
            {
                ...
                output.GeneralData = ObjectGeneratorHelperTest.GetGeneralData(readers[0]);
                output.ItemData = ObjectGeneratorHelperTest.GetItemData(readers[1]);
                output.ExporterData = ObjectGeneratorHelperTest.GetExporterData(readers[2]);
                output.ImporterData = ObjectGeneratorHelperTest.GetImporterData(readers[3]);
                CloseConnection();

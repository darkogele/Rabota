...
// Type: interop.LocalAdminPanel.localuserprofile
...
{
  public class localuserprofile : UserControl
  {
    ...
    {
      this.Session["HelpMenu2"] = (object) "Help/admin/Help_Admin_Profile.aspx";

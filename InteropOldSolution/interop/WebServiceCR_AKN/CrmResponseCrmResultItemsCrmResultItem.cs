...
// Type: interop.WebServiceCR_AKN.CrmResponseCrmResultItemsCrmResultItem
...
namespace interop.WebServiceCR_AKN
{
  ...
  public class CrmResponseCrmResultItemsCrmResultItem : INotifyPropertyChanged
  {
    ...
    private string dateDeletedInCRFieldField;
    ...
    private string terminationBasisFieldField;
    ...
    public string dateDeletedInCRField
    {
      get
      {
        return this.dateDeletedInCRFieldField;
      }
      set
      {
        this.dateDeletedInCRFieldField = value;
        this.RaisePropertyChanged("dateDeletedInCRField");
      }
    }
    ...
    public string terminationBasisField
    {
      get
      {
        return this.terminationBasisFieldField;
      }
      set
      {
        this.terminationBasisFieldField = value;
        this.RaisePropertyChanged("terminationBasisField");
      }
    }

...
// Type: interop.UserPanel.wsusage
...
{
  public class wsusage : UserControl
  {
    ...
    {
      HelpClassWebServices classWebServices = (HelpClassWebServices) this.Session["SelectedWS"];
      if (classWebServices == null)
        return;
      if (classWebServices.ID == 1L)
        this.Session["HelpMenu3"] = (object) "Help/korisnik/HelpServisiImotenListPrebaruvanje.aspx";
      else if (classWebServices.ID == 16L)
        this.Session["HelpMenu3"] = (object) "Help/korisnik/HelpServisiPodatociZaParceliPrebaruvanje.aspx";
      else if (classWebServices.ID == 2L)
        this.Session["HelpMenu3"] = (object) "Help/korisnik/HelpServisiDrzavjanstvoPrebaruvanje.aspx";
      else if (classWebServices.ID == 10L)
        this.Session["HelpMenu3"] = (object) "Help/korisnik/HelpServisiMBAKNPrebaruvanje.aspx";
      else if (classWebServices.ID == 15L)
        this.Session["HelpMenu3"] = (object) "Help/korisnik/HelpServisiMBCUPrebaruvanje.aspx";

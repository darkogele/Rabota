...
namespace Interop.ExternalCC.CrossCutting.Logging
{
    public class NLogger : ILogger
    {
        ...
        #region Error
        public void Error(string message, [CallerMemberName] string memberName = "default", [CallerFilePath] string filePath = "default", [CallerLineNumber] int lineNumber = 0)
        {

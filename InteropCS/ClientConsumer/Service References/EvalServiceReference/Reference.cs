...
namespace ClientConsumer.EvalServiceReference {
    ...
    public interface IEvalService {
        ...
        void SubmitEval(ClientConsumer.EvalServiceReference.Eval eval);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IEvalService/SubmitEval", ReplyAction="http://tempuri.org/IEvalService/SubmitEvalResponse")]
        System.Threading.Tasks.Task SubmitEvalAsync(ClientConsumer.EvalServiceReference.Eval eval);
        ...
        ClientConsumer.EvalServiceReference.Eval[] GetEvals();
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IEvalService/GetEvals", ReplyAction="http://tempuri.org/IEvalService/GetEvalsResponse")]
        System.Threading.Tasks.Task<ClientConsumer.EvalServiceReference.Eval[]> GetEvalsAsync();
    ...
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface IEvalServiceChannel : ClientConsumer.EvalServiceReference.IEvalService, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class EvalServiceClient : System.ServiceModel.ClientBase<ClientConsumer.EvalServiceReference.IEvalService>, ClientConsumer.EvalServiceReference.IEvalService {
        ...
        public void SubmitEval(ClientConsumer.EvalServiceReference.Eval eval) {
            base.Channel.SubmitEval(eval);
        }
        
        public System.Threading.Tasks.Task SubmitEvalAsync(ClientConsumer.EvalServiceReference.Eval eval) {
            return base.Channel.SubmitEvalAsync(eval);
        }
        
        public ClientConsumer.EvalServiceReference.Eval[] GetEvals() {
            return base.Channel.GetEvals();
        }
        
        public System.Threading.Tasks.Task<ClientConsumer.EvalServiceReference.Eval[]> GetEvalsAsync() {

    ...
    public class MimMsgHelper :IMimMsgHelper
    {
        ...
        public OwnCertificate LoadOwnCertificate()
        {
            var result = Helper.ExecuteLogicAndLogException(() =>
            {
                ...
                return output;
            },TypeException.CertificateException,_logger);
        ...
        {
            //TODO:TypeException.SigningMessageException can be thrown

            var result = Helper.ExecuteLogicAndLogException(() => SignXml(soapmsg, ownCert.Certificate),TypeException.DefaultException, _logger);
        ...
        {
            //TODO:TypeException.DecryptingMimMessageException can be thrown
        ...
        {
            //TODO:TypeException.GetPublicKeyException can be thrown

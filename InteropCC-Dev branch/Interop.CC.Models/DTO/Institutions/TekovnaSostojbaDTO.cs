...
{
    public class TekovnaSostojbaDTO : BasicPrintInfoDTO
    {
        ...
        public List<CVLECourt> Court { get; set; }
    ...
    public class CVMembership
    {
        ...
        [XmlElement("MainLeidName")]
        public string MainLeidName { get; set; }

        [XmlElement("Members")]
        public string Members { get; set; }

        [XmlElement("MembersName")]
        public string MembersName { get; set; }
    }
    [XmlType("CrmResultItem")]
    public class CVFounding
    {
        [XmlElement("LEID")]
        public string LEID { get; set; }

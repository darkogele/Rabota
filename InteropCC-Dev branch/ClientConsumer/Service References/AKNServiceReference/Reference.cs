...
namespace ClientConsumer.AKNServiceReference {
    using System.Data;
    
    
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    [System.ServiceModel.ServiceContractAttribute(Namespace="http://www.katastar.gov.mk/", ConfigurationName="AKNServiceReference.Service_MACEDONIAN_CADASTRESoap")]
    public interface Service_MACEDONIAN_CADASTRESoap {
        ...
        [System.ServiceModel.XmlSerializerFormatAttribute(SupportFaults=true)]
        ClientConsumer.AKNServiceReference.dzgr VRATIPODATOCI_STRUKTURA_DZGR(string us, string ps, string ops, string kops, string ilist);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://www.katastar.gov.mk/VRATIPODATOCI_STRUKTURA_DZGR", ReplyAction="*")]
        System.Threading.Tasks.Task<ClientConsumer.AKNServiceReference.dzgr> VRATIPODATOCI_STRUKTURA_DZGRAsync(string us, string ps, string ops, string kops, string ilist);
        ...
        [System.ServiceModel.XmlSerializerFormatAttribute(SupportFaults=true)]
        ClientConsumer.AKNServiceReference.ATRparceli VRATIPODATOCI_STRUKTURA_PARCELA(string us, string ps, string ops, string kops, string broj);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://www.katastar.gov.mk/VRATIPODATOCI_STRUKTURA_PARCELA", ReplyAction="*")]
        System.Threading.Tasks.Task<ClientConsumer.AKNServiceReference.ATRparceli> VRATIPODATOCI_STRUKTURA_PARCELAAsync(string us, string ps, string ops, string kops, string broj);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://www.katastar.gov.mk/VRATIulici", ReplyAction="*")]
        [System.ServiceModel.XmlSerializerFormatAttribute(SupportFaults=true)]
        ClientConsumer.AKNServiceReference.ulici VRATIulici(string us);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://www.katastar.gov.mk/VRATIulici", ReplyAction="*")]
        System.Threading.Tasks.Task<ClientConsumer.AKNServiceReference.ulici> VRATIuliciAsync(string us);
    }
    ...
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface Service_MACEDONIAN_CADASTRESoapChannel : ClientConsumer.AKNServiceReference.Service_MACEDONIAN_CADASTRESoap, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class Service_MACEDONIAN_CADASTRESoapClient : System.ServiceModel.ClientBase<ClientConsumer.AKNServiceReference.Service_MACEDONIAN_CADASTRESoap>, ClientConsumer.AKNServiceReference.Service_MACEDONIAN_CADASTRESoap {
        ...
        public ClientConsumer.AKNServiceReference.dzgr VRATIPODATOCI_STRUKTURA_DZGR(string us, string ps, string ops, string kops, string ilist) {
            return base.Channel.VRATIPODATOCI_STRUKTURA_DZGR(us, ps, ops, kops, ilist);
        }
        
        public System.Threading.Tasks.Task<ClientConsumer.AKNServiceReference.dzgr> VRATIPODATOCI_STRUKTURA_DZGRAsync(string us, string ps, string ops, string kops, string ilist) {
        ...
        public ClientConsumer.AKNServiceReference.ATRparceli VRATIPODATOCI_STRUKTURA_PARCELA(string us, string ps, string ops, string kops, string broj) {
            return base.Channel.VRATIPODATOCI_STRUKTURA_PARCELA(us, ps, ops, kops, broj);
        }
        
        public System.Threading.Tasks.Task<ClientConsumer.AKNServiceReference.ATRparceli> VRATIPODATOCI_STRUKTURA_PARCELAAsync(string us, string ps, string ops, string kops, string broj) {
            return base.Channel.VRATIPODATOCI_STRUKTURA_PARCELAAsync(us, ps, ops, kops, broj);
        }
        
        public ClientConsumer.AKNServiceReference.ulici VRATIulici(string us) {
            return base.Channel.VRATIulici(us);
        }
        
        public System.Threading.Tasks.Task<ClientConsumer.AKNServiceReference.ulici> VRATIuliciAsync(string us) {

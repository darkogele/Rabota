...
namespace Interop.CC.Portal.API.AKNOpshtini {
    ...
    [System.ServiceModel.ServiceContractAttribute(Namespace="http://interop.org/", ConfigurationName="AKNOpshtini.IAKNMunicipality")]
    public interface IAKNMunicipality {
        ...
        Interop.CC.Portal.API.AKNOpshtini.MunicipalityDTO[] GetMunicipalities();
        
        [System.ServiceModel.OperationContractAttribute(Action="http://interop.org/IAKNMunicipality/GetMunicipalities", ReplyAction="http://interop.org/IAKNMunicipality/GetMunicipalitiesResponse")]
        System.Threading.Tasks.Task<Interop.CC.Portal.API.AKNOpshtini.MunicipalityDTO[]> GetMunicipalitiesAsync();
        ...
        Interop.CC.Portal.API.AKNOpshtini.MunicipalityDTO[] GetCMunicipalities(string municipalityValue);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://interop.org/IAKNMunicipality/GetCMunicipalities", ReplyAction="http://interop.org/IAKNMunicipality/GetCMunicipalitiesResponse")]
        System.Threading.Tasks.Task<Interop.CC.Portal.API.AKNOpshtini.MunicipalityDTO[]> GetCMunicipalitiesAsync(string municipalityValue);
    }
    
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface IAKNMunicipalityChannel : Interop.CC.Portal.API.AKNOpshtini.IAKNMunicipality, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class AKNMunicipalityClient : System.ServiceModel.ClientBase<Interop.CC.Portal.API.AKNOpshtini.IAKNMunicipality>, Interop.CC.Portal.API.AKNOpshtini.IAKNMunicipality {
        ...
        public Interop.CC.Portal.API.AKNOpshtini.MunicipalityDTO[] GetMunicipalities() {
            return base.Channel.GetMunicipalities();
        }
        
        public System.Threading.Tasks.Task<Interop.CC.Portal.API.AKNOpshtini.MunicipalityDTO[]> GetMunicipalitiesAsync() {
            return base.Channel.GetMunicipalitiesAsync();
        }
        
        public Interop.CC.Portal.API.AKNOpshtini.MunicipalityDTO[] GetCMunicipalities(string municipalityValue) {
            return base.Channel.GetCMunicipalities(municipalityValue);
        }
        
        public System.Threading.Tasks.Task<Interop.CC.Portal.API.AKNOpshtini.MunicipalityDTO[]> GetCMunicipalitiesAsync(string municipalityValue) {

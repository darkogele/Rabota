...
namespace Interop.CC.Portal.API.UJPEdinstvenDanocenBroj {
    ...
    [System.ServiceModel.ServiceContractAttribute(Namespace="http://interop.org", ConfigurationName="UJPEdinstvenDanocenBroj.IDataForEDB")]
    public interface IDataForEDB {
        ...
        [System.ServiceModel.FaultContractAttribute(typeof(Interop.CC.Portal.API.UJPEdinstvenDanocenBroj.InteropFault), Action="http://interop.org/IDataForEDB/GetEDBInteropFaultFault", Name="InteropFault", Namespace="http://schemas.datacontract.org/2004/07/Contracts.DataAccessLibrary.InteropFault")]
        Interop.CC.Portal.API.UJPEdinstvenDanocenBroj.EDB_EMB_Output[] GetEDB(string emb);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://interop.org/IDataForEDB/GetEDB", ReplyAction="http://interop.org/IDataForEDB/GetEDBResponse")]
        System.Threading.Tasks.Task<Interop.CC.Portal.API.UJPEdinstvenDanocenBroj.EDB_EMB_Output[]> GetEDBAsync(string emb);
    }
    
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface IDataForEDBChannel : Interop.CC.Portal.API.UJPEdinstvenDanocenBroj.IDataForEDB, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class DataForEDBClient : System.ServiceModel.ClientBase<Interop.CC.Portal.API.UJPEdinstvenDanocenBroj.IDataForEDB>, Interop.CC.Portal.API.UJPEdinstvenDanocenBroj.IDataForEDB {
        ...
        public Interop.CC.Portal.API.UJPEdinstvenDanocenBroj.EDB_EMB_Output[] GetEDB(string emb) {
            return base.Channel.GetEDB(emb);
        }
        
        public System.Threading.Tasks.Task<Interop.CC.Portal.API.UJPEdinstvenDanocenBroj.EDB_EMB_Output[]> GetEDBAsync(string emb) {

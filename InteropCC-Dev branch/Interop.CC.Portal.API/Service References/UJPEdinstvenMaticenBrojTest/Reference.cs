...
namespace Interop.CC.Portal.API.UJPEdinstvenMaticenBrojTest {
    ...
    [System.ServiceModel.ServiceContractAttribute(Namespace="http://interop.org", ConfigurationName="UJPEdinstvenMaticenBrojTest.IDataForEMB")]
    public interface IDataForEMB {
        
        [System.ServiceModel.OperationContractAttribute(Action="http://interop.org/IDataForEMB/GetEMB", ReplyAction="http://interop.org/IDataForEMB/GetEMBResponse")]
        [System.ServiceModel.FaultContractAttribute(typeof(Interop.CC.Portal.API.UJPEdinstvenMaticenBrojTest.InteropFault), Action="http://interop.org/IDataForEMB/GetEMBInteropFaultFault", Name="InteropFault", Namespace="http://schemas.datacontract.org/2004/07/Contracts.DataAccessLibrary.InteropFault")]
        Interop.CC.Portal.API.UJPEdinstvenMaticenBrojTest.EDB_EMB_Output[] GetEMB(string edb);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://interop.org/IDataForEMB/GetEMB", ReplyAction="http://interop.org/IDataForEMB/GetEMBResponse")]
        System.Threading.Tasks.Task<Interop.CC.Portal.API.UJPEdinstvenMaticenBrojTest.EDB_EMB_Output[]> GetEMBAsync(string edb);
    }
    
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface IDataForEMBChannel : Interop.CC.Portal.API.UJPEdinstvenMaticenBrojTest.IDataForEMB, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class DataForEMBClient : System.ServiceModel.ClientBase<Interop.CC.Portal.API.UJPEdinstvenMaticenBrojTest.IDataForEMB>, Interop.CC.Portal.API.UJPEdinstvenMaticenBrojTest.IDataForEMB {
        
        public DataForEMBClient() {
        }
        
        public DataForEMBClient(string endpointConfigurationName) : 
                base(endpointConfigurationName) {
        }
        
        public DataForEMBClient(string endpointConfigurationName, string remoteAddress) : 
                base(endpointConfigurationName, remoteAddress) {
        }
        
        public DataForEMBClient(string endpointConfigurationName, System.ServiceModel.EndpointAddress remoteAddress) : 
                base(endpointConfigurationName, remoteAddress) {
        }
        
        public DataForEMBClient(System.ServiceModel.Channels.Binding binding, System.ServiceModel.EndpointAddress remoteAddress) : 
                base(binding, remoteAddress) {
        }
        
        public Interop.CC.Portal.API.UJPEdinstvenMaticenBrojTest.EDB_EMB_Output[] GetEMB(string edb) {
            return base.Channel.GetEMB(edb);
        }
        
        public System.Threading.Tasks.Task<Interop.CC.Portal.API.UJPEdinstvenMaticenBrojTest.EDB_EMB_Output[]> GetEMBAsync(string edb) {
            return base.Channel.GetEMBAsync(edb);
        }
    }
}

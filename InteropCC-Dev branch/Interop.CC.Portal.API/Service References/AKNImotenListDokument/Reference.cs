...
namespace Interop.CC.Portal.API.AKNImotenListDokument {
    ...
    [System.ServiceModel.ServiceContractAttribute(Namespace="http://interop.org/", ConfigurationName="AKNImotenListDokument.IAKNPListDocProduction")]
    public interface IAKNPListDocProduction {
        ...
        Interop.CC.Portal.API.AKNImotenListDokument.AKNDocOutput GetPListDoc(string opstina, string katastarskaOpstina, string brImotenList, string brParcela, bool showEmb);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://interop.org/IAKNPListDocProduction/GetPListDoc", ReplyAction="http://interop.org/IAKNPListDocProduction/GetPListDocResponse")]
        System.Threading.Tasks.Task<Interop.CC.Portal.API.AKNImotenListDokument.AKNDocOutput> GetPListDocAsync(string opstina, string katastarskaOpstina, string brImotenList, string brParcela, bool showEmb);
    }
    
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface IAKNPListDocProductionChannel : Interop.CC.Portal.API.AKNImotenListDokument.IAKNPListDocProduction, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class AKNPListDocProductionClient : System.ServiceModel.ClientBase<Interop.CC.Portal.API.AKNImotenListDokument.IAKNPListDocProduction>, Interop.CC.Portal.API.AKNImotenListDokument.IAKNPListDocProduction {
        ...
        public Interop.CC.Portal.API.AKNImotenListDokument.AKNDocOutput GetPListDoc(string opstina, string katastarskaOpstina, string brImotenList, string brParcela, bool showEmb) {
            return base.Channel.GetPListDoc(opstina, katastarskaOpstina, brImotenList, brParcela, showEmb);
        }
        
        public System.Threading.Tasks.Task<Interop.CC.Portal.API.AKNImotenListDokument.AKNDocOutput> GetPListDocAsync(string opstina, string katastarskaOpstina, string brImotenList, string brParcela, bool showEmb) {
